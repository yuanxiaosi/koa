...
var main = React.createClass({
  ...
  initExcharts: function(obj){
    ...
    var echartsDom = document.querySelectorAll('.dataIncomeStallCharge')[0].querySelector(".echarts")
  ...
  jsExport: function(){
    ExcellentExport.csv(this.refs.jsExport, 'dataIncomeStallChargeTable');
  },
  render: function () {
    var me = this;
    ...
    return (
      <div className="dataIncomeStallCharge">
        <div className="title">
          充值趋势图
        </div>
        <div className="dataIncomeStallChargeHeader">
        ...
        <table className="hide" id="dataIncomeStallChargeTable">
          <tbody>
            <tr>
              <th>日期</th>
              {
