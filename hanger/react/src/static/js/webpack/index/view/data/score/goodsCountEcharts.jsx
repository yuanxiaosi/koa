...
var main = React.createClass({
  ...
  search: function(){
    ...
    indexService.getPointEcharts(data).then(function(res){
      if(res.status == 0){
  ...
  initExcharts: function(obj){
    ...
    var echartsDom = document.querySelectorAll('.goodsCountEcharts')[0].querySelector(".echarts")
  ...
  getXYObj: function(data){
    ...
    for(var i=0; i<data.length; i++){
      ...
      yArr.push(data[i].pointgoodsCount)
    }
    return {
      x: xArr,
      y: yArr
  ...
  jsExport: function(){
    ExcellentExport.csv(this.refs.jsExport, 'goodsCountEchartsTable');
  },
  render: function () {
    var me = this;
    ...
    return (
      <div className="goodsCountEcharts">
        <div className="title">
          礼品兑换趋势图
        </div>
        <div className="goodsCountEchartsHeader">
        ...
        <table className="hide" id="goodsCountEchartsTable">
          <tbody>
            <tr>
              <th>日期</th>
              <th>礼品兑换数</th>
