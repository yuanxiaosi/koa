...
var main = React.createClass({
  ...
  initExcharts: function(obj){
    ...
    var echartsDom = document.querySelectorAll('.goodsPointEcharts')[0].querySelector(".echarts")
  ...
  jsExport: function(){
    ExcellentExport.csv(this.refs.jsExport, 'goodsPointEchartsTable');
  },
  render: function () {
    var me = this;
    ...
    return (
      <div className="goodsPointEcharts">
        <div className="title">
          积分兑换趋势图
        </div>
        <div className="goodsPointEchartsHeader">
        ...
        <table className="hide" id="goodsPointEchartsTable">
          <tbody>
            <tr>
              <th>日期</th>
              <th>积分兑换数</th>
