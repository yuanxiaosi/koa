...
var main = React.createClass({
  ...
  render: function () {
    ...
    return (
      <div className="financeIncomeDetail">
        ...
        <Table
          ...
          title={() => {
            return (
              <div className="sum">
                <div className="list"><span>{totalObj.totalCount}</span>家门店</div>
                <div className="list"><span>{totalObj.totalAmount}</span>合计收入（元）</div>
                <div className="list"><span>{totalObj.goodsTotalAmount}</span>合计商品出库金额（元）（元）</div>
                <div className="list hide"><span>{totalObj.rate}</span>合计商品出库金额（元）占收入比</div>
              </div>
            )
          }}
          footer={() => {
